...
export default {
  ...
  database: {
    ...
    migrationV4Desc: '建立 FTS5 全文搜尋索引（message_fts）並構建索引資料',
    migrationV4Message: '支援全文搜尋，大幅提升關鍵字搜尋速度',
  ...
  ai: {
    tools: {
      ...
      deep_search_messages: {
        desc: '精確子串匹配搜尋聊天紀錄，速度較慢但不會遺漏任何包含關鍵詞的訊息。當普通搜尋（search_messages）結果不足、需要搜尋部分詞或單個字元時使用。',
        params: {
